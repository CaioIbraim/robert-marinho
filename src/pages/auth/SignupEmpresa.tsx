  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        // 3. Criar registro na tabela empresas (Lead para aprovação)
        ...
        if (empErr) console.error("Erro ao criar empresa:", empErr);
    ...
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white uppercase tracking-tighter">Cadastro Empresa</h1>
          <p className="text-text-muted mt-2">Crie sua conta para gerenciar seus pedidos de logística.</p>
        </div>

        <div className="bg-surface border border-border p-8 rounded-3xl shadow-2xl">
          <form onSubmit={handleSignup} className="space-y-5">
            <div className="space-y-1">
              <label className="text-xs font-black uppercase tracking-widest text-text-muted ml-1">Nome da Empresa</label>
            ...
            <div className="space-y-1">
              <label className="text-xs font-black uppercase tracking-widest text-text-muted ml-1">E-mail Corporativo</label>
              <div className="relative">
            ...
            <div className="space-y-1">
              <label className="text-xs font-black uppercase tracking-widest text-text-muted ml-1">Telefone de Contato</label>
              <div className="relative">
