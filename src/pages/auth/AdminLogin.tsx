...
export const AdminLogin = () => {
  ...
  if (isAuthenticated && window.location.pathname === '/admin/login') return <Navigate to="/admin/dashboard" replace />;
      ...
      <div className="flex-1 flex flex-col p-6 md:p-12 lg:p-24 justify-center items-center bg-zinc-950">
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          <div className="text-center md:text-left">
            ...
            <p className="text-zinc-500">Insira suas credenciais para acessar o painel administrativo.</p>
          </div>
