...
export const OperadorSidebar = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-2">
            <SidebarItem to="/operador/dashboard" icon={FaChartBar} label="Dashboard" onClick={onClose} />
            <SidebarItem to="/operador/ordens" icon={FaFileAlt} label="Ordens de Serviço" onClick={onClose} />
          </nav>
